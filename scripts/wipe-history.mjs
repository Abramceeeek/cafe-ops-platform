...
if (!process.argv.includes("--confirm")) {
  console.error(`Refusing to run without --confirm — this DELETES ALL order history on ${kv.SUPABASE_URL}.`);
  console.error("Re-run:  node scripts/wipe-history.mjs --confirm");
  process.exit(1);
}
